...
export const patch = ({ url, params, data }) => request({ method: "patch", url, params, data });

export const put = ({ url, params, data }) => request({ method: "put", url, params, data });

export const deleteRequest = ({ url, params, data }) => request({ method: "delete", url, params, data });